...
path = os.path.join(os.getenv('APPDATA'), 'Thunderstore Mod Manager', 'DataFolder', 'Valheim', 'profiles', 'Default', 'BepInEx', 'plugins')
...
if (username == "dalto"):
    ...
    urllib.request.urlretrieve('http://192.168.1.48:8000/loader/mods.zip', 'mods.zip')
elif (username == "Cal"):
    print("downloading the latest version")
    urllib.request.urlretrieve('http://192.168.1.48:8000/loader/mods.zip', 'mods.zip')
elif (username == "calli"):
    ...
    print("downloading the latest version")
    urllib.request.urlretrieve('http://97.88.21.85:8000/loader/mods.zip', 'mods.zip')
